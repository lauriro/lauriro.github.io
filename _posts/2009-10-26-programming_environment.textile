...
[1]: http://notepad-plus.sourceforge.net/commun/misc/NppShell.zip

h2. Notepad++

with:
* [Context Menu Component][1] copy to your notepad++ directory and run reg.bat

run_editor ( [download](/code/run_editor.sh) ):
    #!/bin/sh
